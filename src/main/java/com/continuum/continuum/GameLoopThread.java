...
public class GameLoopThread extends Thread
{
    ...
    public void run()
    {
        ...
        // cf : surfaceDestroyed() dans com.continuum.continuum.GameView.java
        while (running)
        {
            // horodatage actuel
            startTime = System.currentTimeMillis();

            // mise à jour du déplacement des ojets dans com.continuum.continuum.GameView.update()
...
} // class com.continuum.continuum.GameLoopThread